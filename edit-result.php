...
?>
  ...
  <head>
    ...
    <title>SRGS Admin| Student result info < </title>
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <form class="form-horizontal" method="post">
                        ...
                        $ret = "SELECT tblstudents.StudentName,tblclasses.YearName,tblclasses.Department from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=tblstudents.YearId where tblstudents.StudentId=:stid limit 1";
                        ...
                        if ($stmt->rowCount() > 0) {
                          foreach ($result as $row) {  ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php echo htmlentities($row->YearName) ?>(<?php echo htmlentities($row->Department) ?>)
                              </div>
                            </div>
                            <div class="form-group">
