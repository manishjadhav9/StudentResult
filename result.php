                  ...
                  <div class="panel">
                    <div class="panel-heading">
                      <div class="panel-title">
                        ...
                        $qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.YearName,tblclasses.Department from tblstudents join tblclasses on tblclasses.id=tblstudents.YearId where tblstudents.RollId=:rollid and tblstudents.YearId=:classid ";
                        ...
                        if ($stmt->rowCount() > 0) {
                          foreach ($resultss as $row) {   ?>
                            ...
                            <p><b>Student Class:</b> <?php echo htmlentities($row->YearName); ?>(<?php echo htmlentities($row->Department); ?>)
                            <?php }
