...
?>
  ...
  <head>
    ...
    <title>SRGS Admin| Edit Student  </title>
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <form class="form-horizontal" method="post">
                        ...
                        $sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblstudents.StudentEmail,tblstudents.Gender,tblstudents.DOB,tblclasses.YearName,tblclasses.Department from tblstudents join tblclasses on tblclasses.id=tblstudents.YearId where tblstudents.StudentId=:stid";
                        $query = $dbh->prepare($sql);
                        $query->bindParam(':stid', $stid, PDO::PARAM_STR);
                        $query->execute();
                        ...
                        if ($query->rowCount() > 0) {
                          foreach ($results as $result) {  ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="text" name="yearname" class="form-control" id="yearname" value="<?php echo htmlentities($result->YearName) ?>(<?php echo htmlentities($result->Department) ?>)" readonly>
                              </div>
                            </div>
                            <div class="form-group">
