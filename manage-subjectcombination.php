...
?>
  ...
  <head>
    ...
    <title>Student Result Generation System Admin Manage Subjects Combination</title>
                    ...
                    <div class="panel">
                      ...
                      <div class="panel-body p-20">
                        ...
                        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            <?php $sql = "SELECT tblclasses.YearName,tblclasses.Department,tblsubjects.SubjectName,tblsubjectcombination.id as scid,tblsubjectcombination.status from tblsubjectcombination join tblclasses on tblclasses.id=tblsubjectcombination.YearId  join tblsubjects on tblsubjects.id=tblsubjectcombination.SubjectId";
                            $query = $dbh->prepare($sql);
                            $query->execute();
                            ...
                            if ($query->rowCount() > 0) {
                              foreach ($results as $result) {   ?>
                                <tr>
                                  ...
                                  <td><?php echo htmlentities($result->YearName); ?> &nbsp; Department-<?php echo htmlentities($result->Department); ?></td>
