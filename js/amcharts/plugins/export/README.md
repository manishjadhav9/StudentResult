...
### 1.4.35
* Fixed: Menu handling issue on touch devices, uses css yearname to toggle menu items (updated CSS file, on devices only where the "Touch" object is within window scope)
...
### 1.2.8
* Fixed: Issue in `gatherYearName` checking element type
