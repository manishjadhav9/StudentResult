...
if (strlen($_SESSION['alogin']) == "") {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = 'INSERT INTO tblclasses (YearName, YearNameNumeric, Department) VALUES (:yearname, :yearnamenumeric, :department)';
...
?>
  ...
  <head>
    ...
    <title>Student Result Generation System Admin Create Class</title>
          ...
          <div class="main-page">
            <div class="container-fluid">
              <div class="row page-title-div">
                <div class="col-md-6">
                  <h2 class="title">Create New Class</h2>
                </div>
              </div>
              <!-- /.row -->
                    ...
                    <div class="panel-body">
                      ...
                      <form method="post">
                        <div class="form-group has-success">
                          ...
                          <div class="col-md-10">
                            <input type="text" name="yearname" class="form-control" required="required" id="success">
                        ...
                        <div class="form-group has-success">
                          ...
                          <div class="col-md-10">
                            <input type="number" name="yearnamenumeric" required="required" class="form-control" id="success">
                        ...
                        <div class="form-group has-success">
                          <div class="col-md-10">
                            <button type="submit" name="submit" class="btn btn-primary" value="Submit">Submit<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                          </div>
                      </form>
                    </div>
                  </div>
