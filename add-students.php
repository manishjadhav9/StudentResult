...
if (strlen($_SESSION['alogin']) == "") {
  ...
  if (isset($_POST['submit'])) {
    $studentname = $_POST['fullanme']; // Corrected variable name
    $roolid = $_POST['rollid'];
    ...
    $dob = $_POST['dob'];
    $status = 1;
    $sql = "INSERT INTO tblstudents (StudentName, RollId, StudentEmail, Gender, DOB, YearId) VALUES (:studentname, :roolid, :studentemail, :gender, :dob, :classid)";
...
?>
  ...
  <head>
    ...
    <title>Student Result Generation System Admin| Student Admission </title>
