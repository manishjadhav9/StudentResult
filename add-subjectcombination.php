...
if (strlen($_SESSION['alogin']) == "") {
  ...
  if (isset($_POST['submit'])) {
    ...
    $status = 1;
    $sql = "INSERT INTO  tblsubjectcombination(YearId,SubjectId,status) VALUES(:class,:subject,:status)";
...
?>
  ...
  <head>
    ...
    <title>Student Result Generation System Admin Subject Combination< </title>
